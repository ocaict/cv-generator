        ...
        req.app.render('cv-editor/pdf-view', { 
            ...
            try {
                ...
                const pdf = await page.pdf({
                    ...
                    footerTemplate: `
                        <div style="font-family: 'Inter', Arial, sans-serif; font-size: 8px; color: #94a3b8; width: 100%; display: flex; justify-content: space-between; align-items: center; padding: 0 40px; border-top: 1px solid #f1f5f9; margin-top: 5px;">
                            <div style="font-weight: 700; text-transform: uppercase; letter-spacing: 0.1em;">Generated by OcaTech CV</div>
